...
from hop import get_drop_edge_probs
...
def _drop_edge(edge_index, drop_edge_rate):
    if args.drop_scheme == 'hop':
        return drop_edge_weighted(edge_index, hop_drop_edge_probs, drop_edge_rate, threshold=0.7)
...
if __name__ == '__main__':
    ...
    # ============================================================================
    if args.drop_scheme == 'hop':
        hop_drop_edge_probs = get_drop_edge_probs(data.edge_index).to(device)
    elif args.drop_scheme in ['degree', 'evc', 'pr']:
